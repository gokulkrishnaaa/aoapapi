...
export const EntranceWelcomeAgent = ({
  name = "<Name>",
  registrationNo = 0,
  email = "<Email>",
  phone = "<Phone>",
      ...
      <Body className="bg-white my-auto mx-auto font-sans">
        <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[600px]">
          ...
          <Section className="px-10">
            ...
            <Text className="text-sm leading-6 text-gray-700">
              Your B.Tech Application Number : {registrationNo}
            </Text>
            <Text className="text-sm leading-6 text-gray-700">
              You need to login (https://aee.amrita.edu/) with your registered
              Mobile no. {phone} / Email id. {email} and will be logged in only
              after OTP verification to view your application details and for
              any further process in future.
            </Text>
            <Text className="text-sm leading-6 text-gray-700">
...
export default EntranceWelcomeAgent;
