...
interface CounsellorPassResetProps {
  name: string;
  password: string;
}

export const CounsellorPassReset = ({
  name = "<Name>",
  password = "<Password>",
}: CounsellorPassResetProps) => (
  <Html>
    <Head />
        ...
        <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[600px]">
          ...
          <Section className="px-10">
            ...
            <Text className="text-sm leading-6 text-gray-700">
              We hope this message finds you well. Please find your new
              credentials. Please Login at :{" "}
              <Link
                href="https://aee.amrita.edu/counsellor"
...
export default CounsellorPassReset;
